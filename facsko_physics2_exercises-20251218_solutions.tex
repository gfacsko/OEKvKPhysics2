...
\begin{center}
 (KTXFI2EBNF) Physics II. Exercises Solutions\\ \smallskip
 December~18,~2025
\end{center}
...
\right].
\]
Substituting $W = 4.5\,\text{eV}$ and $k = 8.617 \cdot 10^{-5}\,\text{eV/K}$ yields
\[
...
v_d = \frac{I}{n q A},
\]
where $A = \pi R^{2}$ with $R = 1.5\,\text{mm}$ and $n = 3.3 \cdot 10^{28}\,\text{m}^{-3}$.
Thus,
\[
v_d = \frac{12}{(3.3 \cdot 10^{28})(1.6 \cdot 10^{-19}) \pi (1.5 \cdot 10^{-3})^{2}}
\approx 2.04 \cdot 10^{-4}\,\text{m/s}.
\]
